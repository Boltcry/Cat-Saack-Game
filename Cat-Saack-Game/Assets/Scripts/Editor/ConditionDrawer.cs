...
public class ConditionDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        // Determine the type of the current Condition
        ...
        int newIndex = EditorGUI.Popup(dropdownRect, "Condition Type", currentIndex, typeNames);
        ...
        if (property.isExpanded && property.managedReferenceValue != null)
        {
            ...
            // Iterate through all the fields of the Condition type and draw them
